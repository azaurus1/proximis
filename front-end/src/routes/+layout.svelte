<script>
	...
	import { Sidebar, SidebarGroup, SidebarItem, SidebarWrapper,SidebarBrand, Input } from 'flowbite-svelte';
	...
	import { PUBLIC_POCKETBASE_URL, PUBLIC_POCKETBASE_ACCOUNT, PUBLIC_POCKETBASE_PASS } from '$env/static/public';
...
<div class="flex flex-col w-screen">
	  ...
	  <div class="hidden md:block">
		<Sidebar>
			<SidebarWrapper class="h-screen">
				<SidebarGroup>
					<h6 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white p-4 text-center">Proximis</h6>
					<SidebarItem label="Dashboard" active={activeUrl === '/'}>
					...
					<SidebarItem label="My Incidents" {spanClass}>
						<svelte:fragment slot="icon">
	...
	<div class="flex-1 pl-8 pr-8">
		<div class="h-16 p-4 flex justify-end">
